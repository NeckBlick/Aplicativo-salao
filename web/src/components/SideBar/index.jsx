      ...
      <div className="w-full my-4">
        <ul>
          <li className="flex items-center gap-4 hover:bg-sideBar-hover h-14 text-white">
            ...
            <Link to="agendamentos" className="text-2xl text-white">Agendamentos</Link>
          </li>
          <li className="flex items-center gap-4 hover:bg-sideBar-hover h-14 text-white">
            <FaUserFriends size={30} color="white"/>
            <Link to="clientes" className="text-2xl text-white">Clientes</Link>
          </li>
          <li className="flex items-center gap-4 hover:bg-sideBar-hover h-14 text-white">
            <BsPersonVcard size={30} color="white"/>
            <Link to="colaboradores" className="text-2xl text-white">Colaboradores</Link>
          </li>
          <li className="flex items-center gap-4 hover:bg-sideBar-hover h-14 text-white">
            <BsMagic size={30} color="white"/>
            <Link to="servicos" className="text-2xl text-white">Serviços</Link>
          </li>
          <li className="flex items-center gap-4 hover:bg-sideBar-hover h-14 text-white">
            <AiOutlineClockCircle size={30} color="white"/>
            <Link to="horarios" className="text-2xl text-white">Horários</Link>
          </li>
        </ul>
      </div>
    </div>
